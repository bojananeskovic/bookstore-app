<template>
   <Modal v-model="showAddModal" modalClass="modal-wrapper">
      <h2 class="add__modal-title">Add new Office Supply</h2>
      <div class="modal-content">
        ...
        type="text"
        :maxlength="625"
        placeholder="Enter Office Supply Name"
        v-model="productAdded.name">
        <h3 class="modal-content-name">Office Supply Image</h3>
        ...
        accept="image/*"
        @change="onFilePicked">
        <h3 class="modal-content-name">Office Supply description:</h3>
        <textarea placeholder="Enter Office Supply Description"
        class="modal__product__price-textarea"
        name="desc"
        id="desc"
        :maxlength="200"
        v-model="productAdded.desc"/>
        <h3 class="modal-content-name">Office Supply price:</h3>
        <textarea placeholder="Enter Office Supply Price"
        class="modal__product__price-textarea"
        name="price"
        id="price"
        :maxlength="200"
...
export default {
  ...
  methods: {
    ...
    async confirmAdd() {
      ...
      await this.$store.dispatch('createOfficeSuppliesProduct', officeSuppliesProduct);
