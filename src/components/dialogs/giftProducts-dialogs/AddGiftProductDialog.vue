<template>
   <Modal v-model="showAddModal" modalClass="modal-wrapper">
      <h2 class="add__modal-title">Add new Gift</h2>
      <div class="modal-content">
        <h3 class="modal-content-name">Gift name:</h3>
        <input
        ...
        <h3 class="modal-content-name">Gift Image</h3>
        ...
        accept="image/*"
        @change="onFilePicked">
         <h3 class="modal-content-name">Gift description:</h3>
        <textarea placeholder="Enter Gift Description"
        class="modal__product__price-textarea"
        name="desc"
        id="desc"
        :maxlength="200"
        v-model="productAdded.desc"/>
        <h3 class="modal-content-name">Gift price:</h3>
        <textarea placeholder="Enter Gift Price"
        class="modal__product__price-textarea"
        name="price"
        id="price"
        :maxlength="200"
...
export default {
  ...
  methods: {
    ...
    async confirmAdd() {
      ...
      await this.$store.dispatch('createGiftProduct', giftProduct);
