<template>
    <Modal v-model="showUpdateModal" modalClass="modal-wrapper">
      ...
      <div class="modal-content">
        ...
        <h3 class="modal-content-price">Gift Description:</h3>
        <textarea
         name="desc"
        ...
        <h3 class="modal-content-price">Gift Price:</h3>
        <textarea
         name="price"
  ...
  export default {
    ...
    methods: {
      closeUpdateModal() {
        ...
        this.$emit('updateGiftProduct', this.showUpdateModal);
        this.$emit('originalProduct', this.itemForUpdate);
      },
      async confirmUpdate() {
        await this.$store.dispatch("updateGiftProduct", this.itemForUpdate);
