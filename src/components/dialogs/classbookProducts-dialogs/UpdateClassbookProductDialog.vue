<template>
    <Modal v-model="showUpdateModal" modalClass="modal-wrapper">
      ...
      <div class="modal-content">
        ...
        <h3 class="modal-content-price">Classbook Description:</h3>
        <textarea
         name="desc"
        ...
        <h3 class="modal-content-price">Classbook Price:</h3>
        <textarea
         name="price"
...
<script>
  export default {
    ...
    methods: {
      ...
      async confirmUpdate() {
        await this.$store.dispatch("updateClassbookProduct", this.itemForUpdate);
