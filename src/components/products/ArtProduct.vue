...
<script>
import DeleteArtProductDialog from '../dialogs/artProducts-dialogs/DeleteArtProductDialog.vue';
import UpdateArtProductDialog from '../dialogs/artProducts-dialogs/UpdateArtProductDialog.vue';
...
export default {
   components: {
    ...
    'app-update-art-product-dialog': UpdateArtProductDialog,
  ...
  computed: {
    ...mapState(["artCollection"]),
      filteredArt() {
      return this.artCollection.filter((item) => {
   ...
   mounted() {
    this.$store.dispatch("getArtCollection");
  },
}
</script>
