<template>
  <div class="product-wrapper">
    ...
    <div class="all-products">
      ...
      <div
        v-for="product in filteredboardGames"
        :key="product.id"
        ...
        <img :src="product.src" style="border-radius:20px;" />
         ...
         <h4 @click="showInfo(product)" class="product-show-price">Description</h4><div class="action-buttons">
    ...
    <app-add-boardGames-product-dialog
...
<script>
import DeleteBoardGameProductDialog from '../dialogs/boardGamesProducts-dialogs/DeleteBoardGameProductDialog.vue';
import UpdateBoardGameProductDialog from '../dialogs/boardGamesProducts-dialogs/UpdateBoardGameProductDialog.vue';
import AddBoardGameProductDialog from '../dialogs/boardGamesProducts-dialogs/AddBoardGameProductDialog.vue';
import InfoBoardGameProductDialog from '../dialogs/boardGamesProducts-dialogs/InfoBoardGameProductDialog.vue';
import { mapState } from "vuex";
import { userMixin } from "../../mixins/userMixin";
import { productMixin } from "../../mixins/productMixin";
export default {
   components: {
    'app-delete-boardGames-product-dialog': DeleteBoardGameProductDialog,
    'app-update-boardGames-product-dialog': UpdateBoardGameProductDialog,
    'app-add-boardGames-product-dialog': AddBoardGameProductDialog,
    'app-info-boardGames-product-dialog': InfoBoardGameProductDialog
  },
   mixins: [
    userMixin,
    productMixin
  ...
  // },
  computed: {
    ...mapState(["boardGamesCollection"]),
      filteredboardGames() {
      return this.boardGamesCollection.filter((item) => {
