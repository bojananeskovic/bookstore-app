<template>
  <div class="product-wrapper">
    ...
    <div class="all-products">
      ...
      <div
        v-for="product in filteredOfficeSupplies"
        :key="product.id"
    ...
    <app-add-officeSupplies-product-dialog
...
<script>
import DeleteOfficeSuppliesProductDialog from '../dialogs/officeSuppliesProducts-dialogs/DeleteOfficeSuppliesProductDialog.vue';
import UpdateOfficeSuppliesProductDialog from '../dialogs/officeSuppliesProducts-dialogs/UpdateOfficeSuppliesProductDialog.vue';
...
export default {
   components: {
    ...
    'app-update-officeSupplies-product-dialog': UpdateOfficeSuppliesProductDialog,
  ...
  computed: {
    ...mapState(["officeSuppliesCollection"]),
      ...
      return this.officeSuppliesCollection.filter((item) => {
