<template>
  <div class="product-wrapper">
    ...
    <div class="add-product-button-wrapper">
      ...
      <div
        v-for="product in filteredStationary"
        :key="product.id"
    ...
    <app-add-stationary-product-dialog
...
<script>
import DeleteStationaryProductDialog from '../dialogs/stationaryProducts-dialogs/DeleteStationaryProductDialog.vue';
import UpdateStationaryProductDialog from '../dialogs/stationaryProducts-dialogs/UpdateStationaryProductDialog.vue';
...
export default {
   components: {
    ...
    'app-update-stationary-product-dialog': UpdateStationaryProductDialog,
  ...
  computed: {
    ...mapState(["stationaryCollection"]),
      filteredStationary() {
      return this.stationaryCollection.filter((item) => {
